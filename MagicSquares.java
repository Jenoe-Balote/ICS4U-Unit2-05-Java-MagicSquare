...
final class MagicSquares {
    ...
    /**
    * This constant is the middle left index.
    * */
    public static final int THREE = 3;
    /**
    * This constant is the middle index.
    * */
    public static final int FOUR = 4;
    /**
    * This constant is the middle right index.
    * */
    public static final int FIVE = 5;
    /**
    * This constant is the lower left index.
    * */
    public static final int SIX = 6;
    /**
    * This constant is the lower middle index.
    * */
    public static final int SEVEN = 7;
    /**
    * This constant is the lower right index.
    * */
    public static final int EIGHT = 8;
    /**
    * This constant is the maximum number for magicNumbers.
    * */
    ...
    * */
     ...
     *
     * @param square is the magic square.
     * @param currentSquare is the extra array.
